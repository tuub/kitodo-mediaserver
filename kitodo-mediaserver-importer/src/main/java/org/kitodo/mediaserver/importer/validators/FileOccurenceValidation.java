 ...
 */
public class FileOccurenceValidation implements IMetsValidation {


    private static final Logger LOGGER = LoggerFactory.getLogger(FileOccurenceValidation.class);
     ...
     */
    @Override
    public Object validate(File mets, Map<String, String> parameter) throws ValidationException {
