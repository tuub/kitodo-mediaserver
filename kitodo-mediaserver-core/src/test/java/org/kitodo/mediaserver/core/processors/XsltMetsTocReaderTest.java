    ...
    public void getToc() throws Exception {
        ...
        assertThat(toc,
            hasProperty("tocItems",
                contains(
                    allOf(
                        hasProperty("name", is("cover")),
                        hasProperty("type", is("cover")),
                        hasProperty("pageNumber", is(1)),
                        hasProperty("children", nullValue())
                    ),
                    allOf(
                        hasProperty("name", is("title_page")),
                        hasProperty("type", is("title_page")),
                        hasProperty("pageNumber", is(3)),
                        hasProperty("children", nullValue())
                    ),
                    allOf(
                    ...
                    allOf(
                        hasProperty("name", is("BlankPage")),
                        hasProperty("type", is("BlankPage")),
                        hasProperty("pageNumber", is(179)),
                        hasProperty("children", nullValue())
                    ),
                    allOf(
                    ...
                    allOf(
                        hasProperty("name", is("Postscript")),
                        hasProperty("type", is("Postscript")),
                        hasProperty("pageNumber", is(214)),
                        hasProperty("children", nullValue())
                    ),
                    allOf(
                        hasProperty("name", is("cover")),
                    ...
                    allOf(
                        hasProperty("name", is("ColorChart")),
                        hasProperty("type", is("ColorChart")),
                        hasProperty("pageNumber", is(217)),
                        hasProperty("children", nullValue())
                    )
                )
            )
